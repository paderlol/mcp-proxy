...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .plugin(tauri_plugin_autostart::init(
            ...
            // No extra launch args — the GUI starts with its default window.
            None,
        ))
        .manage(AppState::new())
        .setup(|app| {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::invocations::list_invocation_sessions,
            commands::invocations::list_invocation_tool_calls,
            commands::invocations::invocation_counts_by_tool,
            commands::import::discover_client_servers,
            commands::import::import_servers,
